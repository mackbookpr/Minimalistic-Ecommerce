...
function Categories() {
    return (
        <div className="fixed top-[3.8rem] z-20 bg-white xl:w-[1165px] lg:w-[945px] md:w-[730px] sm:w-[500px] w-[260px] -translate-x-1/2 left-1/2 flex border-2 border-black mb-5 mt-4 flex-wrap h-[40px] text-[10px] md:text-lg sm:text-md">
