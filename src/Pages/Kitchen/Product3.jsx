            ...
            <div className='pt-[8rem]'>
                ...
                <div className={`${containerClass} gap-5`}>
                    <div className="lg:w-1/2 w-full mt-16 lg:mb-8 mb-2 relative md:h-[550px] lg:h-[380px] h-[400px]">
                        <img src={MidnightBakingPaper} alt="" className='w-full h-full object-cover border-2 border-black z-10' />
                    </div>
                ...
                <div className="flex gap-5 mt-5 md:flex-nowrap flex-wrap justify-center">
                    <div className="sm:w-1/3 w-full bg-orange-300 h-[80px] flex items-center justify-center md:text-lg text-sm font-semibold">Weight:3.5kg</div>
