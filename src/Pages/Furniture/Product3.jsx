...
import ShadowHeavenDesk from "../../Assets/Furniture/ShadowHavenDesk.png";
...
function Product2() {
    ...
    const handleAddToCart = () => {
        addToCart({
            id: uuidv4(),
            name: 'ShadowHeavenDesk',
            price: 9000,
            Quantity: Quantity,
            cost: cost,
            productName: "Shadow Heaven Desk"
        });
    };
    ...
    return (
        <>
            ...
            <div className='pt-[8rem]'>
                <h1 className='absolute lg:text-5xl md:text-2xl font-bold flex left-1/2 justify-center -translate-x-1/2 z-10 '>Shadow Heaven Desk</h1>
                <div className={`${containerClass} gap-5`}>
                    <div className="lg:w-1/2 w-full mt-16 lg:mb-8 mb-2 relative md:h-[550px] lg:h-[380px] h-[400px]">
                        <img src={ShadowHeavenDesk} alt="" className='w-full h-full object-cover border-2 border-black z-10' />
                    </div>
