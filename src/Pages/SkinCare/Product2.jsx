...
function Product2() {
    ...
    return (
        <>
            <h1 className='absolute text-5xl font-bold flex left-1/2 justify-center -translate-x-1/2 z-10'>Blue Aura</h1>
            <div className="w-1/2 mt-16 mb-8 relative">
                <img src={BlueSkinCare} alt="" className='w-full h-full object-cover border-2 border-black' />
            </div>
            <div className="w-1/2 bg-orange-200 py-40 px-5 flex text-lg flex-col gap-10 border border-black">
                <p>Blue Aura: Our innovative skincare line captures the essence of the ocean's depths to nurture and revitalize your skin. Infused with marine extracts and blue algae, our products deliver deep hydration, promote elasticity, and impart a refreshing, radiant complexion.</p>
