...
function Product4() {
  ...
  return (
    <>
      <h1 className='absolute text-5xl font-bold flex left-1/2 justify-center -translate-x-1/2'>PurePulse Defibrillator</h1>
      <div className="w-1/2 mt-16 mb-8">
        <img src={WhiteDefibrillator} alt="" className='w-full h-full object-cover rounded-xl' />
      </div>
