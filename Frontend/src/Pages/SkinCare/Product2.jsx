...
function Product1() {
    ...
    const handleAddToCart = () => {
        addToCart({
            ...
            cost: cost,
            category:'Skincare',
            imgName:'BlueSkinCare',
            productName: "Blue Aura"
        });
    };
    ...
    return (
        <>
            ...
            <div className='pt-[8rem]'>
                <h1 className='absolute lg:text-5xl md:text-2xl font-bold flex left-1/2 justify-center -translate-x-1/2 z-10'>Blue Aura</h1>
                <div className={`${containerClass} gap-5`}>
                    <div className="lg:w-1/2 w-full mt-16 lg:mb-8 mb-2 relative md:h-[550px] lg:h-[380px] h-[400px]">
                        <img src={`http://localhost:8080/Public/Skincare/BlueSkinCare.png`} alt="" className='w-full h-full object-cover border-2 border-black' />
                    </div>
                    <div className="lg:w-1/2 w-full bg-orange-200 lg:py-40 py-10 h-auto px-3 flex text-lg flex-col gap-10 border border-black lg:h-[440px] justify-center">
                        <p>
                            Introducing Blue Aura: Elevate your skincare routine with our revolutionary blue skincare line, infused with the soothing essence of the ocean. Experience luminous, healthier-looking skin like never before.</p>
