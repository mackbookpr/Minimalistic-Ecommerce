    ...
    return (
        <>
            ...
            <div className='pt-[8rem]'>
                <h1 className='absolute lg:text-5xl md:text-2xl font-bold flex left-1/2 justify-center -translate-x-1/2 z-10 '>ShadowTech PC</h1>
                <div className={`${containerClass} gap-5`}>
                    ...
                    <img src={`http://localhost:8080/Public/Electronics/BlackComputer.png`} alt="" className='w-full h-full object-cover border-2 border-black' />
                    </div>
                    <div className="lg:w-1/2 w-full bg-orange-200 lg:py-40 py-10 h-auto px-2 flex text-lg flex-col gap-10 border border-black lg:h-[440px] justify-center">
                        <p className='sm:text-left text-center'>Our ShadowTech PC is designed to fit perfectly in any space, whether it's placed against a wall or tucked away in a corner. With its sleek design and powerful performance, it's the perfect choice for anyone looking for a stylish and efficient computer.</p>
