...
function DefaultPage() {
    const images = [
        { src: SkinCare, text: "Revive skin" },
        { src: Kitchen, text: "Refine food" },
        { src: Electronics, text: "New Home" },
        { src: Furniture, text: "Live Well" },
    ];

    return (

        <div className="xl:max-w-[1265px] lg:max-w-[1035px] md:max-w-[830px] m-auto px-12 pt-20 pb-2">
