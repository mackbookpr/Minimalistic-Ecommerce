...
function Product2() {
    ...
    const handleAddToCart = () => {
        addToCart({
            id: uuidv4(),
            name: 'SnowCoffeeMaker',
            price: 9000,
            Quantity: Quantity,
            cost: cost,
            category:'Kitchen',
            productName: "SnowCoffeeMaker"
        });
    };
    ...
    return (
        <>
            ...
            <div className='pt-[8rem]'>
                <h1 className='absolute lg:text-5xl md:text-2xl font-bold flex left-1/2 justify-center -translate-x-1/2 z-10 '>SnowCoffeeMaker</h1>
                <div className={`${containerClass} gap-5`}>
                    <div className="lg:w-1/2 w-full mt-16 lg:mb-8 mb-2 relative md:h-[550px] lg:h-[380px] h-[400px]">
                        <img src={`http://localhost:8080/Public/Kitchen/SnowCoffeeMaker.png`} alt="" className='w-full h-full object-cover border-2 border-black z-10' />
                    </div>
                    <div className="lg:w-1/2 w-full bg-orange-200 lg:py-40 py-10 h-auto px-2 flex text-lg flex-col gap-10 border border-black lg:h-[440px] justify-center">
                        <p className='sm:text-left text-center'>
                            ...
                            Introducing Snow Coffee Maker: Experience the tranquility of winter mornings in every cup, with a sleek and efficient design. Elevate your coffee ritual with the crisp purity of freshly fallen snow. Embrace the perfect blend of style and functionality.</p>
