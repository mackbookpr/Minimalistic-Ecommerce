    ...
    return (
        <>
            ...
            <div className='pt-[8rem]'>
                <h1 className='absolute lg:text-5xl md:text-2xl font-bold flex left-1/2 justify-center -translate-x-1/2 z-10 '>Tangerine Tongs</h1>
                <div className={`${containerClass} gap-5`}>
                    <div className="lg:w-1/2 w-full mt-16 lg:mb-8 mb-2 relative md:h-[550px] lg:h-[380px] h-[400px]">
                        <img src={`http://localhost:8080/Public/Kitchen/TangerineTongs.png`} alt="" className='w-full h-full object-cover border-2 border-black z-10' />
                    </div>
                    <div className="lg:w-1/2 w-full bg-orange-200 lg:py-40 py-10 h-auto px-2 flex text-lg flex-col gap-10 border border-black lg:h-[440px] justify-center">
                        <p className='sm:text-left text-center'>
                            Introducing Tangerine Tongs: Infuse your kitchen with citrus flair, effortlessly blending style and utility. Elevate your cooking experience with vibrant functionality. Embrace the zest of Tangerine Tongs in every culinary creation.</p>
                ...
                <div className="flex gap-5 mt-5 md:flex-nowrap flex-wrap justify-center">
                    <div className="sm:w-1/3 w-full bg-orange-300 h-[80px] flex items-center justify-center md:text-lg text-sm font-semibold">Weight:0.3kg</div>
                    ...
                    <div className="sm:w-1/3 w-full bg-orange-300 h-[80px] flex items-center justify-center md:text-lg text-sm font-semibold">Size:5inch x 4inch</div>
                </div>
                <Trending />
                <Newsletter />
                <Footer />
